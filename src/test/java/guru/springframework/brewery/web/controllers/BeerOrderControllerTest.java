...
class BeerOrderControllerTest {
    ...
    void testListOrders() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/e8d68f2a-b86b-4244-965c-4cbeae5bf124/orders"))
    ...
    void testGetOrder() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/e8d68f2a-b86b-4244-965c-4cbeae5bf124/orders/f7994080-7eaa-4ada-8187-542273d636c6"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8));
